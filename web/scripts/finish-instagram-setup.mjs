...
/**
 * Finish Instagram Setup with App ID and App Secret
 * Gets Access Token and User ID
 */
...
console.log('\n📸 Instagram API Setup - Finishing Setup')
console.log('='.repeat(60))
console.log(`\n✅ App ID: ${APP_ID}`)
console.log(`✅ App Secret: ${APP_SECRET.substring(0, 10)}...`)
console.log('\nNow we need Access Token and User ID...\n')

async function main() {
  // Step 1: Access Token
  printStep(1, 'Get Access Token')
  console.log('\n📋 Quick Method:')
  ...
  console.log('OR use this direct link (after selecting your app):')
  console.log('https://developers.facebook.com/tools/explorer/?method=GET&path=me%3Ffields%3Did%2Cname&version=v18.0\n')
  ...
  // Step 2: User ID (try auto-fetch)
  printStep(2, 'Get User ID')
  ...
  // Step 4: Test
  printStep(4, 'Testing Connection')
  ...
  console.log(`   https://graph.instagram.com/access_token?grant_type=ig_exchange_token&client_secret=${APP_SECRET}&access_token=${accessToken.trim()}`)
  console.log('\n')
