...
/**
 * Complete Instagram Setup with New Token
 */
...
const ACCESS_TOKEN = 'EAAQ3LymMPSUBQSAA0tXT0LWXDEy3AZCWFtrhSA7yU9ZCRwWZBBmDeiNgRRZASWFcZBnySKHfyftDVlHbXQQsXmLD75a6nkFyZBBEsQRBp33ysHPppghIRLCJJQfaLO8ONK656IGZA9SFXOTtt4vZBHGXvwi6JKwTiqr89ORSrtHTniEIxAHRI1KbZAVTRVm5oz7XIi8C4Ppgj5onXYqlEsdQzMzLl8a3ZAXFLMuidi7RBkbFaoX851'

async function main() {
  console.log('\n📸 Completing Instagram Setup with New Token')
  ...
  if (!userId) {
    try {
      ...
      console.log('⚠️  Could not check Facebook pages:', error.message)
    }
  }
