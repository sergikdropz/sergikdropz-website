              ...
              {isExpanded ? (
                ...
                >
                  ...
                  {item.type === 'video' ? (
                    ...
                    item.mediaUrl === '/images/gallery/logo.png' ? (
                ...
                // Thumbnail view
                hasFailed || item.mediaUrl === '/images/gallery/logo.png' ? (
                  ...
                  >
                    ...
                    <Image
                      src={item.type === 'video' 
                        ? (item.thumbnailUrl || item.mediaUrl || '/placeholder.png') // Videos: use thumbnail
                        : (item.mediaUrl || item.thumbnailUrl || '/placeholder.png') // Images: use actual media
                      }
                      alt={`Instagram post ${index + 1}`}
                      fill
