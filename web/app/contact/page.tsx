    ...
    <div className="pt-20 min-h-screen relative">
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <section className="mb-16 bg-gray-900/60 p-8 rounded-lg">
          ...
          <section className="mb-16">
            ...
            <div className="bg-gray-900/60 p-8 rounded-lg">
              <ContactForm />
            </div>
          </section>
          ...
          <section className="mb-16">
            <div className="text-center mb-12">
              <h2 className="text-5xl md:text-6xl font-bold mb-4">Book SERGIK</h2>
            ...
            {/* Location & Travel */}
            <div className="mb-12">
              <h3 className="text-3xl font-semibold mb-4">Location & Travel</h3>
            ...
            {/* Available For */}
            <div className="mb-12 bg-gray-900/60 p-8 rounded-lg">
              <h3 className="text-3xl font-semibold mb-4">Available For</h3>
            ...
            {/* Booking Form */}
            <div className="mb-16">
              <h3 className="text-3xl font-semibold mb-6">Booking Inquiry</h3>
              <form onSubmit={handleBookingSubmit} className="space-y-6 bg-gray-900/60 p-8 rounded-lg">
