...
const platformLinks: Record<string, { icon: any; label: string; color: string }> = {
  ...
  TIDAL: { icon: SiTidal, label: 'TIDAL', color: 'text-blue-400 hover:text-blue-300' },
  Beatport: { icon: SiBeatport, label: 'Beatport', color: 'text-yellow-500 hover:text-yellow-400' },
}
