...
const platformLinks: Record<string, { icon: any; label: string; color: string }> = {
  ...
  YouTube: { icon: FaYoutube, label: 'YouTube', color: 'text-red-500 hover:text-red-400' },
  ...
  Traxsource: { icon: FaMusic, label: 'Traxsource', color: 'text-orange-400 hover:text-orange-300' },
  Bandcamp: { icon: FaMusic, label: 'Bandcamp', color: 'text-cyan-400 hover:text-cyan-300' },
  Mixcloud: { icon: FaMusic, label: 'Mixcloud', color: 'text-violet-400 hover:text-violet-300' },
  Pandora: { icon: FaMusic, label: 'Pandora', color: 'text-blue-500 hover:text-blue-400' },
  Deezer: { icon: FaMusic, label: 'Deezer', color: 'text-purple-500 hover:text-purple-400' },
  Shazam: { icon: FaMusic, label: 'Shazam', color: 'text-cyan-500 hover:text-cyan-400' },
  iHeartRadio: { icon: FaMusic, label: 'iHeartRadio', color: 'text-red-400 hover:text-red-300' },
  'Claro Música': { icon: FaMusic, label: 'Claro Música', color: 'text-red-500 hover:text-red-400' },
  JioSaavn: { icon: FaMusic, label: 'JioSaavn', color: 'text-teal-400 hover:text-teal-300' },
  Boomplay: { icon: FaMusic, label: 'Boomplay', color: 'text-red-500 hover:text-red-400' },
  Anghami: { icon: FaMusic, label: 'Anghami', color: 'text-purple-400 hover:text-purple-300' },
  'NetEase Cloud Music': { icon: FaMusic, label: 'NetEase', color: 'text-red-400 hover:text-red-300' },
  'Tencent Music': { icon: FaMusic, label: 'Tencent Music', color: 'text-sky-400 hover:text-sky-300' },
  Qobuz: { icon: FaMusic, label: 'Qobuz', color: 'text-zinc-300 hover:text-white' },
  Joox: { icon: FaMusic, label: 'Joox', color: 'text-green-400 hover:text-green-300' },
  Flo: { icon: FaMusic, label: 'Flo', color: 'text-blue-400 hover:text-blue-300' },
  TikTok: { icon: FaMusic, label: 'TikTok', color: 'text-cyan-400 hover:text-cyan-300' },
  Instagram: { icon: FaMusic, label: 'Instagram', color: 'text-pink-400 hover:text-pink-300' },
  Audiomack: { icon: FaMusic, label: 'Audiomack', color: 'text-orange-400 hover:text-orange-300' },
  Snapchat: { icon: FaMusic, label: 'Snapchat', color: 'text-yellow-300 hover:text-yellow-200' },
  MassiveMusic: { icon: FaMusic, label: 'MassiveMusic', color: 'text-pink-400 hover:text-pink-300' },
  Roblox: { icon: FaMusic, label: 'Roblox', color: 'text-sky-400 hover:text-sky-300' },
}
